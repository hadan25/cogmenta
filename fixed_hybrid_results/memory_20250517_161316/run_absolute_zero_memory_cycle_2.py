...
save_dir = "C:\\Users\\ha25a\\.vscode\\cogmenta_core\\fixed_hybrid_results\\memory_20250517_161316\\memory\\cycle_2\\absolute"
...
try:
    if model_type == "memory":
        ...
        model = MemorySNN(neuron_count=1500)
        ...
        model = DecisionSNN(neuron_count=1500)
        ...
        model = MetacognitiveSNN(neuron_count=1500)
        ...
        model = PerceptualSNN(neuron_count=1500)
        ...
        model = ReasoningSNN(neuron_count=1500)
        ...
        model = AffectiveSNN(neuron_count=1500)
