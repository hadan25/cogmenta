...
save_dir = "C:\\Users\\ha25a\\.vscode\\cogmenta_core\\fixed_hybrid_results\\all_20250517_142033\\affective\\cycle_2\\absolute"
...
try:
    if model_type == "memory":
        ...
        model = MemorySNN(neuron_count=194581)
        ...
        model = DecisionSNN(neuron_count=194581)
        ...
        model = MetacognitiveSNN(neuron_count=194581)
        ...
        model = PerceptualSNN(neuron_count=194581)
        ...
        model = ReasoningSNN(neuron_count=194581)
        ...
        model = AffectiveSNN(neuron_count=194581)
