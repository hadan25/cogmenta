...
# Root of the repository - adjust from the results directory back to the repo root
cogmenta_root = parent_dir
if 'fixed_hybrid_results' in current_dir:
    cogmenta_root = os.path.dirname(os.path.dirname(current_dir.split('fixed_hybrid_results')[0]))

# Add necessary paths to sys.path
sys.path.insert(0, cogmenta_root)  # Add the repo root to sys.path
sys.path.insert(0, os.path.join(cogmenta_root, 'absolute_zero'))  # Add absolute_zero directory

print(f"Adding paths: current_file={current_file}, cogmenta_root={cogmenta_root}")
...
save_dir = "C:\\Users\\ha25a\\.vscode\\cogmenta_core\\fixed_hybrid_results\\memory_20250517_163011\\memory\\cycle_1\\absolute"
